...
<?= $this->tag->form(['tipocodigo_modulo/save', 'method' => 'post', 'autocomplete' => 'off', 'class' => 'form-horizontal']) ?>
...
<?= $this->tag->hiddenField(['idHiddenTipoCodigo']) ?>
<?= $this->tag->hiddenField(['idHiddenModulo']) ?>
